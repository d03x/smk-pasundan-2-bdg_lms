...
import TugasController, { periksaTugas } from '@/actions/App/Http/Controllers/Guru/TugasController';
...
function routeToTugas(){
    router.visit(periksaTugas().url)
}
</script>
    ...
    <div class="mt-5 space-y-3">
        ...
        <TugasItem v-if="tugas.length > 0" v-for="i in tugas" :key="i.tugasID" :item="i">
            <template #buttons="item">
                <Button @click="routeToTugas" class="w-full px-3 py-1.5 text-xs sm:w-auto"> Periksa </Button>
            </template>
        </TugasItem>
